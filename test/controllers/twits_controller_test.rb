...
class TwitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twit" do
    assert_difference("Twit.count") do
      post twits_url, params: { twit: { description: @twit.description, userName: @twit.userName } }
    end
  ...
  test "should update twit" do
    patch twit_url(@twit), params: { twit: { description: @twit.description, userName: @twit.userName } }
